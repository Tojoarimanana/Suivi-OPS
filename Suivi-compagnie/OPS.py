...
def main():
    ...
    if file_path is not None:
        ...
        gdf = gpd.read_file("C:/Users/ADMIN/mon_powerbi_python/shapfile/Blocs_2006.shp")

        # MERGE des données Excel et shapefile via le nom du bloc
        ...
        with col1:
            ...
            if selected_columns:
                ...
                # Ajouter le style CSS pour afficher les contenus au survol
                st.markdown("""
                    <style>
        ...
        with col2:
             # Calculer les centroids après re-projection
            centroid = gdf.geometry.centroid

            # Obtenir la moyenne des coordonnées X et Y des centroids
            map_center = [centroid.y.mean(), centroid.x.mean()]

            # Création de la carte avec les coordonnées recalculées
            m = folium.Map(location=map_center, zoom_start=6)

            # Affichage des blocs filtrés en fonction de la compagnie sélectionnée
